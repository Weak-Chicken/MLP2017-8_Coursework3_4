...
This code is not written by us. This is provided by the FMA project, which could be found at
https://github.com/CSTR-Edinburgh/mlpractical  They provided this code to interpret their
metadata.

Some changes are made so that we can run this code on our machine.
